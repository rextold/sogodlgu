    ...
    <div class="row">
        <div class="col-md-9">
            ...
            @for($i=0; $i<$rowCount;$i++)
                <div class="row p-2">
                    @foreach($elected as $i => $value)
                        <div class="col-md-3">
                            <h4 class="text-center"><strong></strong></h4>
                            <div class="profile-card-4 text-center">
                                <img src="{{ Voyager::image($value->official->image, 'cropped') }}" class="img img-responsive">

                                <div class="profile-content">
                                    <div class="profile-name">{{ $value->official->name }}
                                        <p></p>
                                    </div>
                                    <div class="profile-description">{{ $value->position->name }}</div>
                                </div>
                            </div>
                        </div>
                    @endforeach
