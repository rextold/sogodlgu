...
.leo-hero .hero-icon  { font-size: 2.8rem; color: rgba(244,197,66,0.5); margin-bottom: 10px; }
.leo-hero .hero-tag   {
...
.leo-hero h1 { font-size: 2rem; font-weight: 900; color: #fff; margin-bottom: 6px; }
