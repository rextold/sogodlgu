                ...
                <div class="leo-intro-banner" data-aos="fade-up">
                    ...
                    <div class="lib-text">
                        @if($page === 'Sangguniang Bayan Officials')
                            ...
                            <p>The Sangguniang Bayan (SB) is the local legislative body of the Municipality of Sogod. Its members enact ordinances, approve resolutions, and appropriate funds for the municipality.</p>
                        @else
