...
.about-hero .hero-icon { font-size: 2.8rem; color: rgba(244,197,66,0.55); margin-bottom: 10px; }
.about-hero .hero-tag {
...
.about-hero h1 { font-size: 2rem; font-weight: 900; color: #fff; margin-bottom: 6px; line-height: 1.2; }
