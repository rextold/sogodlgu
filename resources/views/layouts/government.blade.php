...
<head>
    ...
    <style>
        body { font-family: 'Inter', 'Segoe UI', Roboto, sans-serif !important; }
        h1,h2,h3,h4,h5,h6 { font-family: 'Poppins', 'Segoe UI', sans-serif !important; }
    </style>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('government') }}">{{ __('HOME') }}</a>
                            </li>
                            <li class="divider"></li>
                            <li class="nav-item active">
                                <a class="nav-link" href="{{ route('government') }}">{{ __('GOVERNMENT') }}</a>
                            </li>
                            <li class="nav-item">
